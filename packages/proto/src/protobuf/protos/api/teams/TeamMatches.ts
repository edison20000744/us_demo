...
// @generated from protobuf file "protobuf/protos/api/teams/TeamMatches.proto" (package "ApiProtos.Teams.TeamMatches", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ApiProtos.Teams.TeamMatches.TeamMatches
 */
export interface TeamMatches {
    /**
     * @generated from protobuf field: ApiProtos.Teams.TeamMatches.TeamMatches.Matches matches = 1;
     */
    matches?: TeamMatches_Matches; // 賽事資訊
    /**
...
/**
 * @generated from protobuf message ApiProtos.Teams.TeamMatches.TeamMatches.Matches
 */
export interface TeamMatches_Matches {
    /**
...
class TeamMatches$Type extends MessageType<TeamMatches> {
    constructor() {
        super("ApiProtos.Teams.TeamMatches.TeamMatches", [
            { no: 1, name: "matches", kind: "message", T: () => TeamMatches_Matches },
    ...
    create(value?: PartialMessage<TeamMatches>): TeamMatches {
        const message = { leagues: [], teams: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TeamMatches>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamMatches): TeamMatches {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* ApiProtos.Teams.TeamMatches.TeamMatches.Matches matches */ 1:
                    message.matches = TeamMatches_Matches.internalBinaryRead(reader, reader.uint32(), options, message.matches);
                    break;
    ...
    internalBinaryWrite(message: TeamMatches, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* ApiProtos.Teams.TeamMatches.TeamMatches.Matches matches = 1; */
        if (message.matches)
            TeamMatches_Matches.internalBinaryWrite(message.matches, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message ApiProtos.Teams.TeamMatches.TeamMatches
 */
export const TeamMatches = new TeamMatches$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TeamMatches_Matches$Type extends MessageType<TeamMatches_Matches> {
    constructor() {
        super("ApiProtos.Teams.TeamMatches.TeamMatches.Matches", [
    ...
    create(value?: PartialMessage<TeamMatches_Matches>): TeamMatches_Matches {
        const message = { futureMatches: [], pastMatches: [], nextUrl: "", totalPage: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TeamMatches_Matches>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamMatches_Matches): TeamMatches_Matches {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TeamMatches_Matches, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message ApiProtos.Teams.TeamMatches.TeamMatches.Matches
 */
export const TeamMatches_Matches = new TeamMatches_Matches$Type();
