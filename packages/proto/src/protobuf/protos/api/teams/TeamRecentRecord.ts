...
// @generated from protobuf file "protobuf/protos/api/teams/TeamRecentRecord.proto" (package "ApiProtos.Teams.TeamRecentRecord", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord
 */
export interface TeamRecentRecord {
    ...
    /**
     * @generated from protobuf field: repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Match matches = 10;
     */
    matches: TeamRecentRecord_Match[]; // 賽事資訊
    /**
     * @generated from protobuf field: repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.League leagues = 11;
     */
    leagues: TeamRecentRecord_League[]; // 聯盟資訊
    /**
     * @generated from protobuf field: repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Team teams = 12;
     */
    teams: TeamRecentRecord_Team[]; // 隊伍資訊
}
/**
 * @generated from protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Match
 */
export interface TeamRecentRecord_Match {
    /**
     ...
     */
    asiaResult: string; // 歐賠結果 home(主勝)/away(客勝)/tie(平手)
    /**
...
/**
 * @generated from protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.League
 */
export interface TeamRecentRecord_League {
    /**
...
/**
 * @generated from protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Team
 */
export interface TeamRecentRecord_Team {
    /**
...
class TeamRecentRecord$Type extends MessageType<TeamRecentRecord> {
    constructor() {
        super("ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord", [
            ...
            { no: 10, name: "matches", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamRecentRecord_Match },
            { no: 11, name: "leagues", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamRecentRecord_League },
            { no: 12, name: "teams", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TeamRecentRecord_Team }
        ]);
    }
    create(value?: PartialMessage<TeamRecentRecord>): TeamRecentRecord {
        const message = { win: 0, lost: 0, tie: 0, total: 0, winRate: 0, bigCount: 0, bigRate: 0, smallCount: 0, smallRate: 0, matches: [], leagues: [], teams: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TeamRecentRecord>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamRecentRecord): TeamRecentRecord {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 smallRate */ 9:
                    ...
                    break;
                case /* repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Match matches */ 10:
                    message.matches.push(TeamRecentRecord_Match.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.League leagues */ 11:
                    message.leagues.push(TeamRecentRecord_League.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Team teams */ 12:
                    message.teams.push(TeamRecentRecord_Team.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
    ...
    internalBinaryWrite(message: TeamRecentRecord, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 win = 1; */
        if (message.win !== 0)
        ...
        /* repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Match matches = 10; */
        for (let i = 0; i < message.matches.length; i++)
            TeamRecentRecord_Match.internalBinaryWrite(message.matches[i], writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.League leagues = 11; */
        for (let i = 0; i < message.leagues.length; i++)
            TeamRecentRecord_League.internalBinaryWrite(message.leagues[i], writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* repeated ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Team teams = 12; */
        for (let i = 0; i < message.teams.length; i++)
            TeamRecentRecord_Team.internalBinaryWrite(message.teams[i], writer.tag(12, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord
 */
export const TeamRecentRecord = new TeamRecentRecord$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TeamRecentRecord_Match$Type extends MessageType<TeamRecentRecord_Match> {
    constructor() {
        super("ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Match", [
    ...
    create(value?: PartialMessage<TeamRecentRecord_Match>): TeamRecentRecord_Match {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TeamRecentRecord_Match>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamRecentRecord_Match): TeamRecentRecord_Match {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TeamRecentRecord_Match, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 matchId = 1; */
...
/**
 * @generated MessageType for protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Match
 */
export const TeamRecentRecord_Match = new TeamRecentRecord_Match$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TeamRecentRecord_League$Type extends MessageType<TeamRecentRecord_League> {
    constructor() {
        super("ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.League", [
    ...
    create(value?: PartialMessage<TeamRecentRecord_League>): TeamRecentRecord_League {
        const message = { leagueId: 0, name: "", shortName: "", logo: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TeamRecentRecord_League>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamRecentRecord_League): TeamRecentRecord_League {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TeamRecentRecord_League, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 leagueId = 1; */
        if (message.leagueId !== 0)
...
/**
 * @generated MessageType for protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.League
 */
export const TeamRecentRecord_League = new TeamRecentRecord_League$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TeamRecentRecord_Team$Type extends MessageType<TeamRecentRecord_Team> {
    constructor() {
        super("ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Team", [
    ...
    create(value?: PartialMessage<TeamRecentRecord_Team>): TeamRecentRecord_Team {
        const message = { teamId: 0, name: "", shortName: "", logo: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TeamRecentRecord_Team>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TeamRecentRecord_Team): TeamRecentRecord_Team {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TeamRecentRecord_Team, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 teamId = 1; */
        if (message.teamId !== 0)
...
/**
 * @generated MessageType for protobuf message ApiProtos.Teams.TeamRecentRecord.TeamRecentRecord.Team
 */
export const TeamRecentRecord_Team = new TeamRecentRecord_Team$Type();
